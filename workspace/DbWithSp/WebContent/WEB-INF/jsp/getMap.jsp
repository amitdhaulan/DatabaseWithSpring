...
<title>Pojo to Json Serialization using Jersey with Jackson for
	Java REST Services</title>
...
<body>
	<h1>Pojo to Json Serialization using Jersey with Jackson for Java
		REST Services</h1>
	<ul>
