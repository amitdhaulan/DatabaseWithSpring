 ...
 */
public class CancelReservationList extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reservationListView = (ListView) findViewById(R.id.cancelreservation_listview);
        textView = (TextView) findViewById(R.id.cancelreservation_nodata);
        backButton = (Button) findViewById(R.id.cancelreservation_button_back);
        /*checkinButton = (Button) findViewById(R.id.reservation_button_checkin);*/
        cancelButton = (Button) findViewById(R.id.cancelreservation_button_cancel);
       ...
       /* try{
            ...
            hide = intent.getStringExtra("hide");

            if(hide.equals("hidecheckinbutton")){
                *//*checkinButton.setVisibility(View.GONE);*//*
                *//*reservationListView.setClickable(false);*//*
                reservationListView.setOnClickListener(null);
            }if(hide.equals("hidecancelbutton")){
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CancelReservationList.this, requestcentral.class);
        ...
        if (v == cancelButton) {
            ...
            if (!checkedinArrayList.contains("!checkedin")) {
                ...
                if (positionStringArrayList.size() == 0) {
                    ...
                    checkedinArrayList.clear();
                    for (int i = 0; i < myReservationClassesArrayList.size(); i++) {
                        checkedinArrayList.add("!checkedin");
                    }
                    ...
                    try {
                        ...
                        if (myReservationClassesArrayList.size() == 0) {
    ...
    public class getReservationSpaces extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = ProgressDialog.show(CancelReservationList.this, "", "");
